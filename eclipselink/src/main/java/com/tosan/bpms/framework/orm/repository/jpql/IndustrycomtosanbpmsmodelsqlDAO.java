 ...
 */
public class IndustrycomtosanbpmsmodelsqlDAO {
  ...
  public static java.util.List save(EntityManager entityManager, java.util.List models) {
    ...
    if (fetch != null && fetch.size() > 0) {
      ...
      while (fetchIterator.hasNext()) {
        ...
        com.tosan.bpms.model.sql.Industry model =
            (com.tosan.bpms.model.sql.Industry) fetchIterator.next();

        if (model != null) {

          String key = model.getIndustryId() + "";
    ...
    while (iterator.hasNext()) {
      com.tosan.bpms.model.sql.Industry model = (com.tosan.bpms.model.sql.Industry) iterator.next();

      if (model != null) {
        String key = model.getIndustryId() + "";
        com.tosan.bpms.model.sql.Industry fetchModel =
            (com.tosan.bpms.model.sql.Industry) existMap.get(key);
  ...
  public static java.util.List getByFilter(
    ...
    com.tosan.bpms.model.sql.Industry model = null;
    if (isFetch == false) {
      fetch = "";
    }
    ...
    java.lang.String select = "SELECT Industry0";
    if (selectParam != null && !selectParam.equals("")) {
      select = selectParam;
    }
    if (!isExistRecord && !isDelete) {
      if (fetchType == FetchType.LAZY) {
        basicQuery = select + " FROM com.tosan.bpms.model.sql.Industry Industry0  WHERE 1=1 ";
      } else if (fetchType == FetchType.EAGER) {
        basicQuery = select + " FROM com.tosan.bpms.model.sql.Industry Industry0  WHERE 1=1 ";
      }
    } else if (isExistRecord) {
      basicQuery = "SELECT Industry0 FROM com.tosan.bpms.model.sql.Industry Industry0 WHERE 1=1 ";
    } else if (isDelete) {
      if (fetchType == FetchType.LAZY) {
        basicQuery = "DELETE FROM com.tosan.bpms.model.sql.Industry Industry0 WHERE 1=1 ";
      } else if (fetchType == FetchType.EAGER) {
        basicQuery = "DELETE Industry Industry0 WHERE 1=1 ";
      }
    }
    ...
    if (modelsLength > 0) {
      while (modelsIterator.hasNext()) {
        model = (com.tosan.bpms.model.sql.Industry) modelsIterator.next();
        query = "";
        isOpenParentheses = true;

        if (model != null) {

          if (isExistRecord == true && model.getIndustryId() == null) {
            model.setIndustryId("");
            isChangeKey = true;
          }
          ...
          if (model.getIndustryId() != null) {
            ...
            if (isExistRecord || isDelete) {
              if (isDelete && fetchType == FetchType.EAGER) {
                whereQuery = " Industry0.id = ? ";
                counter++;
              } else {
                whereQuery = " Industry0.industryId = :Industry0industryId" + j + " ";
              }
            } else {

              whereQuery = " Industry0.industryId LIKE :Industry0industryId" + j + " ";
            }
            ...
            if (isExistRecord || isDelete) {
              if (isDelete && fetchType == FetchType.EAGER) {
                ...
                whereValue = model.getIndustryId();
              }
            } else {
              whereValue = "%" + model.getIndustryId() + "%";
            }
            if (isExistRecord && isChangeKey) {
              model.setIndustryId(null);
              isChangeKey = false;
            }
            ...
            query +=
                (andCondition
                    + Facade.getStatement(
                        statement,
                        "Industry0.industryId",
                        "Industry0industryId" + j,
                        mapVariable,
                        whereQuery,
                        whereValue,
                        isExistRecord,
          ...
          if (!isExistRecord && true && model.getFaTitle() != null) {
            ...
            query += " ";
            if (isDelete && fetchType == FetchType.EAGER) {
              whereQuery = " Industry0.faTitle = ? ";
              counter++;
            } else {
              whereQuery = " Industry0.faTitle = :Industry0faTitle" + j + " ";
            }
          ...
          if (!isExistRecord && true && model.getEnTitle() != null) {
            ...
            query += " ";
            if (isDelete && fetchType == FetchType.EAGER) {
              whereQuery = " Industry0.enTitle = ? ";
              counter++;
            } else {
              whereQuery = " Industry0.enTitle = :Industry0enTitle" + j + " ";
            }
          ...
          if (!isExistRecord && true && model.getVersion() != 0) {
            ...
            query += " ";
            if (isDelete && fetchType == FetchType.EAGER) {
              whereQuery = " Industry0.VERSION = ? ";
              counter++;
            } else {
              whereQuery = " Industry0.version = :Industry0version" + j + " ";
            }
    ...
    if (!isDelete) {
      ...
      if (cast != null
          && result != null
          && result.size() > 0
          && (!select.trim().equals("Industry0") && select.indexOf("new") == -1)) {
