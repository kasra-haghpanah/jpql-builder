 ...
 */
public class LogcomtosanbpmsmodelsqlDAO {
  ...
  public static java.util.List save(EntityManager entityManager, java.util.List models) {
    ...
    if (fetch != null && fetch.size() > 0) {
      ...
      while (fetchIterator.hasNext()) {
        ...
        com.tosan.bpms.model.sql.Log model = (com.tosan.bpms.model.sql.Log) fetchIterator.next();
    ...
    while (iterator.hasNext()) {
      com.tosan.bpms.model.sql.Log model = (com.tosan.bpms.model.sql.Log) iterator.next();

      if (model != null) {
        String key = model.getId() + "";
        com.tosan.bpms.model.sql.Log fetchModel = (com.tosan.bpms.model.sql.Log) existMap.get(key);
  ...
  public static java.util.List getByFilter(
    ...
    com.tosan.bpms.model.sql.Log model = null;
    if (isFetch == false) {
      fetch = "";
    }
    ...
    java.lang.String select = "SELECT Log0";
    if (selectParam != null && !selectParam.equals("")) {
      select = selectParam;
    }
    if (!isExistRecord && !isDelete) {
      if (fetchType == FetchType.LAZY) {
        basicQuery = select + " FROM com.tosan.bpms.model.sql.Log Log0  WHERE 1=1 ";
      } else if (fetchType == FetchType.EAGER) {
        basicQuery = select + " FROM com.tosan.bpms.model.sql.Log Log0  WHERE 1=1 ";
      }
    } else if (isExistRecord) {
      basicQuery = "SELECT Log0 FROM com.tosan.bpms.model.sql.Log Log0 WHERE 1=1 ";
    } else if (isDelete) {
      if (fetchType == FetchType.LAZY) {
        basicQuery = "DELETE FROM com.tosan.bpms.model.sql.Log Log0 WHERE 1=1 ";
      } else if (fetchType == FetchType.EAGER) {
        basicQuery = "DELETE log Log0 WHERE 1=1 ";
      }
    }
    ...
    if (modelsLength > 0) {
      while (modelsIterator.hasNext()) {
        model = (com.tosan.bpms.model.sql.Log) modelsIterator.next();
        query = "";
        ...
        if (model != null) {
          ...
          if (!isExistRecord && true && model.getClassName() != null) {
            ...
            query += " ";
            if (isDelete && fetchType == FetchType.EAGER) {
              whereQuery = " Log0.class = ? ";
              counter++;
            } else {
              whereQuery = " Log0.className = :Log0className" + j + " ";
            }

            isOpenParentheses = false;
            whereValue = model.getClassName();
            query +=
                (andCondition
                    + Facade.getStatement(
                        statement,
          ...
          if (!isExistRecord && true && model.getMethod() != null) {
            ...
            query += " ";
            if (isDelete && fetchType == FetchType.EAGER) {
              whereQuery = " Log0.method = ? ";
              counter++;
            } else {
              whereQuery = " Log0.method = :Log0method" + j + " ";
            }

            isOpenParentheses = false;
            whereValue = model.getMethod();
            query +=
                (andCondition
                    + Facade.getStatement(
                        statement,
          ...
          if (!isExistRecord && true && model.getDate() != null) {
            ...
            query += " ";
            if (isDelete && fetchType == FetchType.EAGER) {
              whereQuery = " Log0.date = ? ";
              counter++;
            } else {
              whereQuery = " Log0.date = :Log0date" + j + " ";
            }
          ...
          if (!isExistRecord && true && model.getException() != null) {
            ...
            query += " ";
            if (isDelete && fetchType == FetchType.EAGER) {
              whereQuery = " Log0.exception = ? ";
              counter++;
            } else {
              whereQuery = " Log0.exception = :Log0exception" + j + " ";
            }

            isOpenParentheses = false;
            whereValue = model.getException();
            query +=
                (andCondition
                    + Facade.getStatement(
                        statement,
          ...
          if (!isExistRecord && true && model.getVersion() != 0) {
            ...
            query += " ";
            if (isDelete && fetchType == FetchType.EAGER) {
              whereQuery = " Log0.version = ? ";
              counter++;
            } else {
              whereQuery = " Log0.version = :Log0version" + j + " ";
            }
          ...
          if (!isExistRecord && true) {
            ...
            query += " ";
            if (isDelete && fetchType == FetchType.EAGER) {
              whereQuery = " Log0.bool = ? ";
              counter++;
            } else {
              whereQuery = " Log0.bool = :Log0bool" + j + " ";
            }

            isOpenParentheses = false;
            whereValue = new java.lang.Boolean("" + model.isBool());
            query +=
                (andCondition
                    + Facade.getStatement(
                        statement,
          ...
          if (!isExistRecord && true && model.getBoolCapital() != null) {
            ...
            query += " ";
            if (isDelete && fetchType == FetchType.EAGER) {
              whereQuery = " Log0.boolCapital = ? ";
              counter++;
            } else {
              whereQuery = " Log0.boolCapital = :Log0boolCapital" + j + " ";
            }

            isOpenParentheses = false;
            whereValue = model.getBoolCapital();
            query +=
                (andCondition
                    + Facade.getStatement(
                        statement,
    ...
    if (!isDelete) {
      ...
      if (cast != null
          && result != null
          && result.size() > 0
          && (!select.trim().equals("Log0") && select.indexOf("new") == -1)) {
